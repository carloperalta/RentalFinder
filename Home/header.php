        ...
        <div class="container">
            <div class="row">
                <div class="header-inner">
					<img src="<?php echo base_url('rf_icon.png'); ?>" alt="Logo">         
                    <nav role="navigation" class="nav navbar-nav navbar-right">
                     <ul >
                        <?php if(!isset($FULLNAME)){ ?>
                          ...
                          <li class="cta">
                            <a style="border-color:#fdc600;" href="<?php echo base_url('Login'); ?>">Login</a>
                          </li>
                          <li class="cta"><a style="border-color:#fdc600;" href="<?php echo base_url('Register') ?>">Signup</a></li>
                          <?php } else{ ?>
