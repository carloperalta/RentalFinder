	...
	-->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="<?php echo base_url('Owner/tenant_list') ?>">
                        <i class="ti-view-list-alt"></i>
                        <p>Tenants</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('Owner/property') ?>">
                        <i class="ti-text"></i>
                        <p>Property</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('Owner/inbox'); ?>">
                        <i class="ti-pencil-alt2"></i>
                        <p>Inbox (Invoices)</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('Owner/maps'); ?>">
                        <i class="ti-map"></i>
                        <p>Maps</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('Owner/notifications'); ?>">
                        <i class="ti-bell"></i>
                        <p>Notifications</p>
                    </a>
                </li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                      ...
                                      <ul class="dropdown-menu">
                                        ...
                                        <li> 
                                            <button class="btn btn-danger" data-toggle="modal" data-target="#myModal">Logout</button>
